...
return ( <div className="min-h-screen bg-[#FAF8F5] flex flex-row">
{/* Sidebar Navigation */}
<Sidebar
    ...
    <main className="flex-1 overflow-y-auto">
      ...
      {currentView === 'audit_trail' && (
        <div className="p-8 max-w-7xl mx-auto space-y-4">
          ...
          <div className="border border-[#E5E0DA] bg-white rounded-xl p-8 text-center text-xs text-[#786F66]">
            Audit Trail & Officer Action Logs module. Select Dashboard or
            Tenders to navigate back.
          </div>
        </div>
      )}
      ...
      {currentView === 'settings' && (
        <div className="p-8 max-w-7xl mx-auto space-y-4">
          ...
          <div className="border border-[#E5E0DA] bg-white rounded-xl p-8 text-center text-xs text-[#786F66]">
            GeM Compliance Engine & Notification Settings. Select Dashboard
            or Tenders to navigate back.
          </div>
        </div>
      )}
    </main>
